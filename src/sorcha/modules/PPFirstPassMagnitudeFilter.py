...
def PPFirstPassMagnitudeFilter(
    ...
    if activity_choice:
        ...
        subclass_offset += ca_model.maxBrightness(aux_df)

    if lightcurve_choice:
        lc_model = LC_METHODS.get(lightcurve_choice)()
        subclass_offset += lc_model.maxBrightness(aux_df)
    ...
    for filt in observing_filters:
        ...
        drop_df[filt] = app_mag - subclass_offset > max_five_sigma[filt] + 2
